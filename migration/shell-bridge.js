...
(function () {
  ...
  const views = {home:'home',challenge:'challenge',build:'builder',leveler:'leveler',about:'about',changelog:'changelog',enchant:'enchanting',spell:'spellmaking',alchemy:'alchemy',travel:'travel',vault:'vault'};
