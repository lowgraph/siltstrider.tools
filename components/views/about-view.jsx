  ...
  return (
    <div className="about-view-root w-full max-w-4xl mx-auto p-4 md:p-6 space-y-6" id="about-content">
      <div className="border-b border-[#d4b06a] pb-4">
        <h2 className="text-2xl md:text-3xl font-serif text-[#d4b06a] tracking-wide">About Silt Strider</h2>
        <p className="text-sm text-[#9e8b6b] mt-1 font-serif">Morrowind Build Planner &amp; Challenge Run Generator</p>
      </div>

      <div className="space-y-4 text-sm leading-relaxed text-[#f3e6c8]">
        <div className="about-legal space-y-3 bg-[#181510] p-4 border border-[#332717] rounded-none">
          <p>
          ...
          <p className="text-xs text-[#9e8b6b] border-t border-[#231b11] pt-3">
        ...
        <div className="about-credits space-y-4 bg-[#181510] p-4 border border-[#332717] rounded-none">
          <div>
            <h3 className="text-base font-serif text-[#d4b06a] mb-1">Credits</h3>
            <p className="text-xs text-[#c9b897]">Typeface: Pelagiad by Isak Larborn, used under the SIL Open Font License 1.1.</p>
            <p className="text-xs text-[#c9b897] mt-1">
          ...
          <div className="border-t border-[#231b11] pt-3">
            <h3 className="text-base font-serif text-[#d4b06a] mb-1">Colophon</h3>
            <p className="text-xs text-[#c9b897]">
          ...
          <div className="border-t border-[#231b11] pt-3">
            <h3 className="text-base font-serif text-[#d4b06a] mb-1">Corrections</h3>
            <p className="text-xs text-[#c9b897]">
              Spotted a mistake? Email <a href="mailto:tmarcalferreira@gmail.com" className="text-[#d4b06a] underline hover:text-[#f3e6c8]">tmarcalferreira@gmail.com</a>.
            </p>
          </div>

          <div className="border-t border-[#231b11] pt-3">
            <h3 className="text-base font-serif text-[#d4b06a] mb-1">Support</h3>
            <p className="text-xs text-[#c9b897]">
              Hosting and tools cost roughly $60/year. If the site is useful to you, a donation helps cover it:{" "}
              <a href="https://ko-fi.com/tmarcalferreira" target="_blank" rel="noopener noreferrer" className="text-[#d4b06a] underline hover:text-[#f3e6c8]">
                Ko-fi
              </a>
              , or{" "}
              <a href="https://www.paypal.com/ncp/payment/CELX7C97ZJ2D6" target="_blank" rel="noopener noreferrer" className="text-[#d4b06a] underline hover:text-[#f3e6c8]">
                PayPal
              </a>
              .
            </p>
