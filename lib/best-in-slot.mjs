 ...
 */
export function resolveBestInSlotPicks(featureData, build, { allowFormidableSources = false, beast = false } = {}) {
  ...
  if (armorRows.length > 0) {
    groups.push({ label: 'Optimized Armor & Shield', rows: armorRows });
  }
