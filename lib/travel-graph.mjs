...
export function buildNetworkGraph(world = "vanilla") {
  const isTr = world === "tr";
  const graph = {};
...
export function getAvailableTransitStops(world = "vanilla") {
  const graph = buildNetworkGraph(world);
 ...
 */
export function findFewestHopsRoute(start, destination, world = "vanilla") {
