...
export const FEATURE_CATALOGS = Object.freeze({
  ...
  enchanting: Object.freeze(['MagicEffects','GameSettings','Enchantments','EffectRules','Merchants','Attributes','Skills']),
  spellmaking: Object.freeze(['MagicEffects','GameSettings','EffectRules','Merchants','Attributes','Skills']),
