...
export function adaptCharacterCatalogs(bundle,spells){
 ...
 return {profile:bundle.profile,bundleId:bundle.bundleId,snapshotId:bundle.snapshotId,races,classes,signs,skills:skills.map(s=>skillNames[s.skill]),specSkills,raceSpells,signSpells,identity,labelFor};
}
