...
const source=path.resolve(process.argv[2] || 'A:/Cache/OpenMWBundlePreview');
...
if(JSON.stringify(stagedManifest)!==JSON.stringify(manifest))throw new Error('Existing manifest differs');
